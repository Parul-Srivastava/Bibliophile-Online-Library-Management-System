...
<div class="container">
	...
	<?php
		...
		{
			$q=mysqli_query($db,"SELECT first,last,username,rollno,email,phoneno FROM `student` where username like '%$_POST[search]%' ");
		...
		{
			$res=mysqli_query($db,"SELECT first,last,username,rollno,email,phoneno FROM `student`;");
