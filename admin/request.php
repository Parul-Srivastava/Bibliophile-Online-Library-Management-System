...
<div class="container">
	...
	if(isset($_SESSION['login_user']))
	{
		$sql= "SELECT student.username,rollno,books.bid,name,authors,edition,status FROM student inner join issue_info ON student.username=issue_info.username inner join books ON issue_info.bid=books.bid WHERE issue_info.approve =''";
